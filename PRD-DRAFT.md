...
4. Темна тема форуму<br>
    > **plusxx:** <br>
    > На початку можна додати лише темну, а потім допиляти ще кілька або кільканадцять.<br><br><hr>
5. Всі основні функції повинні працювати без JS
    ...
    > Треба зробити так, щоб навіть з лінкса користувач міг притомно користуватись з ресурсу
      ...
      повний можливий функціонал і швидкість, котре може дати JS.<br><br><hr>
6. Система карми
    > **plusxx:** <br>
    ...
    > * Ввести систему ачівок.<br><br><hr>
7. Удосконалений редактор постів
    > **plusxx:** <br>
    > Думаю, тут все зрозуміло. Треба лише вибрати найадекватніше рішення цього питання.<br><br><hr>
8. Зробити тяжкою реєстрацію клонів.<br><br><hr>
9. На початках ніяк. 
      > * Забити на це і активніше модерувати.
      > * Однак якийсь механізм на майбутнє можна закласти, щоб активувати його пізніше.<br><br><hr>
10. Адаптивна верстка сторінок
    > **plusxx:** <br>
    > Тут думаю, все ясно, єдине пропоную використати Bootstrap або щось подібне.<br><br><hr>
11. Відповідь все погано однією кнопкою (див. нижче)<br><br><hr>
12. Розділ очікуючи на виправлення
    > **plusxx:** <br>
    > Якщо модератор бачить, що питання з формулюванням не правильно, він в один клік може кинути тему в розділ "очікує на виправлення",
      ...
      Тему в розділі "Очікує на виправлення" можуть бачити лише адміни, модератори і автор.<br><br><hr>
13. Посилання на конкретний пост<br><br><hr>
14. Удосконалений механізм пошуку по сайту<br><br><hr>
15. Емоджі
    > **plusxx:** <br>
...
16. Мочжливість поскаржитись модераторові.
    ...
    > <br><br>
    <hr>
17. Додати закриті (приватні) теми<br>
    > **plusxx:** <br>
    ...
    > <br><br>
    <hr>
18. Типу шелл для програмування (я так розумію, емулятор терміналу в браузері)
    > **P.Y.:** <br>
    ...
    > <hr><br>
19. Структура коментарів<br>
    >**wander:**<br>
    > Я б хотів зберегти максимальну схожість з форумом, на скільки це можливо. Тому я б залишав потоком, як тут.
    >**P.Y.:**<br>
    >Тільки не гілки — на 5 рівні вкладеності коментарі в них уже стають малодоступними для читання.
   ...
   ><br><br>
    <hr>
20. Особисті повідомлення і повідомлення з закритих тем зберігаються в закодованому вигляді
